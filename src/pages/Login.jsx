...
const LoginPage = () => {
  ...
  return (
    <Box sx={style.container}>
      <center>
        <Typography sx={{ fontSize: "2rem", fontWeight: 500, marginTop: "5%" }}>
          Login to password Manger
        </Typography>
      </center>
      <Box sx={style.form}>
        <TextField
        ...
        <Typography sx={{color:'#00b4d8',fontWeight:500,cursor:'pointer'}} >sign up</Typography>
        </Box>
      </Box>
    </Box>
  );
